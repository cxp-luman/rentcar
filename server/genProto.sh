...
protoc -I=$PROTO_PATH --go-grpc_out=require_unimplemented_servers=false,paths=source_relative:$GO_OUT_PATH  --go_out=paths=source_relative:$GO_OUT_PATH auth.proto
